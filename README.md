...
- **Tela Sobre:** apresenta informações sobre o projeto e o autor.

## 🛠️ Tecnologias Utilizadas
- Android Studio  
- Java  
- XML  
- Appetize.io (para teste online)

## 📸 Capturas de Tela
*(adicione prints do Android Studio mostrando as telas)*

## 👩‍💻 Autora
**Bianca Correia**  
Acadêmica do curso de [Nome do curso] – [Nome da faculdade]  
📅 Ano: 2025
